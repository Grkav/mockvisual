  ...
  return (
    <>
      ...
      >
        ...
        <td className="px-2 py-2 text-[11px] text-right">{tarefa.peso > 0 ? fmt(tarefa.peso, "peso") : "--"}</td>
        <td className="px-2 py-2 text-[11px] text-right">{tarefa.cubagem > 0 ? fmt(tarefa.cubagem, "cubagem") : "--"}</td>
        <td className="px-2 py-2 text-[11px] text-right font-medium">{fmt(tarefa.valorTotal, "moeda")}</td>
        ...
        <table className="w-full text-[11px] border-collapse">
          ...
          <tbody className="bg-white">
            ...
            <TotalRow>
              ...
              <td />
              <td />
              <td className="px-2 py-1.5 text-[11px] text-right font-bold">{fmt(filtrados.reduce((s, t) => s + t.peso, 0), "peso")}</td>
              <td className="px-2 py-1.5 text-[11px] text-right font-bold">{fmt(filtrados.reduce((s, t) => s + t.cubagem, 0), "cubagem")}</td>
              <td className="px-2 py-1.5 text-[11px] text-right font-bold">{fmt(filtrados.reduce((s, t) => s + t.valorTotal, 0), "moeda")}</td>
              <td colSpan={7} />
            </TotalRow>
          </tbody>
        </table>
